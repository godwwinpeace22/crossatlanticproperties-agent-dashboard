// Extract pending interests from payments
...
export const MyInterests = ({ payments, interests }: MyInterestsProps) => {
  ...
  return (
    <div className="container mx-auto py-8 pt-0 space-y-6">
      ...
      {interests &&
        interests.filter((i) => i.status === "pending").length > 0 && (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold">Pending Investments</h2>
            <div className="space-y-2">
              {interests
                ...
                .map((interest) => (
                  <div
                    key={interest.id}
                    className="flex items-center justify-between p-3 border rounded bg-yellow-50"
                  >
                    <div>
                      <p className="font-medium">
                        {interest.property?.name || "Property"}
                      </p>
